...
void b2World::DrawShape(b2Fixture* fixture, const b2Transform& xf, const b2Color& _color)
{
	// FRANKENGINE START - make sensors more alpha in debug
	b2Color color = _color;
	color.a *= (fixture && fixture->IsSensor()) ? 0.2f : 1;
	// FRANKENGINE END
